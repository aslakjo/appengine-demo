...
\kontrast{Aslak Johannessen \\ \hfill \\\small aslakjo@bekk.no \\ @aslakjo}
...
\begin{frame}{Google Appengine}
  \begin{content}
    \begin{textblock}{10}(5,0)
      \includegraphics[scale=0.3]{img/google}\\
      \includegraphics[scale=0.5]{img/gae}
    \end{textblock}
    \begin{itemize}
      \item Hosting
      \item Cloud / skyen      
...
\kontrast{\includegraphics[height=5em]{duke} \\javax.servlet.http.HttpServlet \\ ant package || mvn war:war}
...
\kontrast{Spørsmål? \\\hfill\\ \small http://github.com/aslakjo/appengine-demo}
