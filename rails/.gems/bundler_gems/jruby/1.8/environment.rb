...
module Bundler
 ...
 dir = File.dirname(file)
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/activesupport-2.3.9/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/actionmailer-2.3.9/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/extlib-0.9.15/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rails_appengine-0.0.5/lib")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/actionpack-2.3.9/lib")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/addressable-2.2.1/lib")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/activerecord-2.3.9/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/dm-ar-finders-0.10.2/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rails_dm_datastore-0.2.10/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/activeresource-2.3.9/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rails-2.3.9/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rails-2.3.9/lib")
